...
public class SlidingTileGFSDistanceTest {

    @Test
    void test_case_one(){
        ArrayList<Integer> dataSet = new ArrayList<Integer>(Arrays.asList(7,2,4,5,0,6,8,3,1));
        SlidingTileGFSDistanceHeuristic slidingTileGFSDistanceHeuristic = new SlidingTileGFSDistanceHeuristic(dataSet);
        assertEquals(true, slidingTileGFSDistanceHeuristic.search());
    }
