...
public class SlidingTileAStarDistanceTest {

    @Test
    void test_case_one(){
        ArrayList<Integer> dataSet = new ArrayList<Integer>(Arrays.asList(7,2,4,5,0,6,8,3,1));
        SlidingTileAStarDistanceHeuristic slidingTileAStarDistanceHeuristic = new SlidingTileAStarDistanceHeuristic(dataSet);
        assertEquals(true, slidingTileAStarDistanceHeuristic.search());
    }
